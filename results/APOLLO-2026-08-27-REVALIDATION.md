# PixelML Apollo full revalidation — 2026-08-27
...
- Authenticated direct API plus CLIProxy/OpenCodex alias
  `agenticflow/apollo-glm-5.3-flash`.
...
A fresh ephemeral OpenCodex run selected
`agenticflow/apollo-glm-5.3-flash` through the local OpenCodex proxy. GLM was
